...
#### c is the 3rd row (there is only one column), so it is equal to -0.9949558. 
...
```
#### The standard error of this estimate is 0.2151166.
...
```
#### The standard deviation for the slope estimate appears to be within 17.5-17.7 inches range
...
```
#### As there is no single minimum, all of the above are the smallest Least Square Residuals.
